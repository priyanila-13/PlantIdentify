...
print(os.listdir("E:\PlantIdentification\data"))
...
for directory_path in glob.glob("E:\PlantIdentification\data"):
...
data_dir = 'E:\\PlantIdentification\\data'
...
lgbm_params = {'learning_rate':0.05, 'boosting_type':'dart',    
              ...
              'num_leaves':100,
              'max_depth':10,
              'num_class':30}  #no.of unique values in the target class not inclusive of the end value


lgb_model = lgb.train(lgbm_params, d_train, 1000) #50 iterations. Increase iterations for small learning rates
